...
export interface ERC1155MixedFungibleInterface extends utils.Interface {
  functions: {
...
export interface ERC1155MixedFungible extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155MixedFungibleInterface;
