...
export interface RandomnessRelayL2Interface extends utils.Interface {
  functions: {
    "authority()": FunctionFragment;
    "fulfillRandomness(uint256,uint32[])": FunctionFragment;
...
export interface RandomnessRelayL2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RandomnessRelayL2Interface;
  ...
  callStatic: {
    ...
    updateL2Target(l1Target_: string, overrides?: CallOverrides): Promise<void>;
  };
