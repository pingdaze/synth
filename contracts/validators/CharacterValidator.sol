...
contract CharacterValidator is Ownable {
  ...
  */
    ...
    function _generateDrops(uint256 characterId, uint256 seed) internal {
        Character memory characterInstance = character.getCharacter(
            characterId
        );
        uint8 chance;
        uint8 roll;
        ...
        uint8 rarity;
        uint8 form = _compareMem(characterInstance.traitsPlus[0], "Pepel")
            ? 1
            : 2;
    ...
    function _getRarityFromRoll(uint8 roll)
        internal
        pure
